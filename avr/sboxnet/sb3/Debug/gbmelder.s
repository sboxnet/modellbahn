...
.Ltext0:
	...
	.section	.text.read_sensors,"ax",@progbits
	.type	read_sensors, @function
read_sensors:
.LFB44:
	.file 1 ".././gbmelder.c"
	.loc 1 172 0
...
.LBB150:
	.file 2 ".././common.h"
	.loc 2 426 0
	lds r24,g_sensor_bits_1
	lds r25,g_sensor_bits_1+1
.LVL3:
	movw r18,r22
	eor r18,r24
	eor r19,r25
.LVL4:
	.loc 2 428 0
	lds r24,g_sensor_bits
	lds r25,g_sensor_bits+1
	eor r24,r22
	eor r25,r23
	and r24,r18
	and r25,r19
	...
	eor r24,r22
	eor r25,r23
	sts g_sensor_bits,r24
	sts g_sensor_bits+1,r25
	.loc 2 431 0
	sts g_sensor_bits_1,r22
	sts g_sensor_bits_1+1,r23
.LVL5:
.LBE150:
.LBE149:
.LBB151:
...
.L10:
	...
	sub r30,r24
	sbc r31,r25
	subi r30,lo8(-(g_sensors+5))
	sbci r31,hi8(-(g_sensors+5))
	ld r18,Z
	sbrc r18,1
	rjmp .L4
	.loc 1 184 0
	...
	sbc r31,r25
	movw r26,r30
	subi r26,lo8(-(g_sensors+5))
	sbci r27,hi8(-(g_sensors+5))
	.loc 1 185 0
	ori r18,lo8(1)
	ori r18,lo8(1<<1)
	st X,r18
	.loc 1 186 0
	subi r30,lo8(-(g_sensors))
	sbci r31,hi8(-(g_sensors))
...
.L4:
	...
	st Z,r18
	.loc 1 190 0
	lds r30,g_sensor_bits
	lds r31,g_sensor_bits+1
	or r30,r20
	or r31,r21
	sts g_sensor_bits,r30
	sts g_sensor_bits+1,r31
	.loc 1 200 0
...
.L1:
	...
	.cfi_endproc
.LFE44:
	.size	read_sensors, .-read_sensors
...
.LBE176:
	...
	brsh .L28
	.loc 1 108 0
	sts g_dec_lastaddr,__zero_reg__
	sts g_dec_lastaddr+1,__zero_reg__
	.loc 1 109 0
	tst r24
	brlt .L34
	.loc 1 110 0
	ldi r25,0
	sts g_dec_lastaddr,r24
	sts g_dec_lastaddr+1,r25
	rjmp .L35
.L34:
	.loc 1 111 0
	ldi r25,lo8(64)
...
.L35:
	.loc 1 114 0
	lds r24,g_dec_lastaddr
	lds r25,g_dec_lastaddr+1
	or r24,r25
	breq .L28
.LBB178:
	.loc 1 115 0
...
.LBB179:
.LBB180:
	.file 4 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\util\\atomic.h"
	.loc 4 50 0
/* #APP */
...
.LBB195:
.LBB196:
	.file 5 "C:\\Users\\balagi\\Documents\\git/avrutilslib/ringbuffer.h"
	.loc 5 53 0
	ldi r30,lo8(g_locoaddr_pipe)
	ldi r31,hi8(g_locoaddr_pipe)
	ldd r24,Z+2
	ldd r19,Z+3
	sub r24,r19
.LVL34:
...
.LBE194:
	...
	brlo .L43
	.loc 1 135 0
	lds r28,g_sensor_bits
	lds r29,g_sensor_bits+1
	.loc 1 132 0
	com r25
.LVL35:
	.loc 1 133 0
...
.LBE197:
	.loc 1 140 0
	lds r22,g_dec_lastaddr+1
.LVL42:
.LBB199:
.LBB200:
	.loc 2 408 0
	ldi r24,lo8(g_locoaddr_pipe)
	ldi r25,hi8(g_locoaddr_pipe)
	call ringbuf_write
.LVL43:
.LBE200:
.LBE199:
...
.LFE43:
	...
	.section	.text.multiplex_leds,"ax",@progbits
.global	multiplex_leds
	.type	multiplex_leds, @function
multiplex_leds:
.LFB45:
	.loc 1 216 0
	.cfi_startproc
...
.LVL71:
	...
	.cfi_endproc
.LFE45:
	.size	multiplex_leds, .-multiplex_leds
	.section	.text.get_next_transmit_seq,"ax",@progbits
.global	get_next_transmit_seq
	.type	get_next_transmit_seq, @function
get_next_transmit_seq:
.LFB46:
	.loc 1 230 0
	.cfi_startproc
/* prologue: function */
...
.LBE217:
	...
	sts g_transmit_seq,r24
	.loc 1 245 0
	ret
	.cfi_endproc
.LFE46:
	.size	get_next_transmit_seq, .-get_next_transmit_seq
...
.L62:
	...
	.loc 1 343 0
	ldi r24,lo8(__c.4573)
	ldi r25,hi8(__c.4573)
	std Z+10,r24
	std Z+11,r25
.LVL79:
.LBB231:
.LBB232:
	...
	ldd r24,Z+13
	ldd r25,Z+14
	ldi r26,lo8(g_led_timer)
	ldi r27,hi8(g_led_timer)
	st X+,r24
	st X,r25
	sbiw r26,1
	.loc 2 362 0
...
.LBE233:
	.loc 1 352 0
	ldi r24,lo8(112)
	ldi r30,lo8(g_sensors)
	ldi r31,hi8(g_sensors)
	movw r26,r30
	0:
	st X+,__zero_reg__
	dec r24
...
.LBB238:
	...
	ldd r24,Z+15
	ldd r25,Z+16
	ldi r26,lo8(g_power_on_timer)
	ldi r27,hi8(g_power_on_timer)
	st X+,r24
	st X,r25
	sbiw r26,1
	.loc 2 359 0
...
.LBB242:
	...
	andi r30,0xf0
	eor r31,r30
	subi r30,lo8(-(g_eeprom+4097))
	sbci r31,hi8(-(g_eeprom+4097))
	.loc 1 369 0 discriminator 2
	ld r24,Z
.LVL87:
.LBE242:
...
.LVL116:
.L100:
	.loc 1 429 0 is_stmt 0 discriminator 4
	sts g_holdtime,r22
...
.L103:
	...
	sbc r31,r19
	movw r28,r30
	subi r28,lo8(-(g_sensors))
	sbci r29,hi8(-(g_sensors))
	std Y+4,r22
...
.LFE51:
	...
	.section	.text.show_occuppy_leds,"ax",@progbits
.global	show_occuppy_leds
	.type	show_occuppy_leds, @function
show_occuppy_leds:
.LFB52:
	.loc 1 454 0
	.cfi_startproc
...
/* epilogue start */
	...
	.cfi_endproc
.LFE52:
	.size	show_occuppy_leds, .-show_occuppy_leds
...
.LBB295:
	...
	sbc r23,r21
	movw r20,r22
	subi r20,lo8(-(g_sensors))
	sbci r21,hi8(-(g_sensors))
	movw r30,r20
	std Z+1,r16
	std Z+2,r17
	.loc 1 525 0
...
.LBB297:
	...
	sbc r13,r15
	movw r24,r12
	subi r24,lo8(-(g_sensors))
	sbci r25,hi8(-(g_sensors))
	movw r10,r24
	ldi r24,lo8(50)
	movw r30,r10
	std Z+6,r24
...
.LBB341:
	...
	sbc r27,r23
	movw r22,r26
	subi r22,lo8(-(g_sensors))
	sbci r23,hi8(-(g_sensors))
	movw r30,r22
	std Z+1,r16
	std Z+2,r17
	.loc 1 581 0
...
.LBE342:
	...
	rjmp .L142
	.loc 1 613 0
	ldi r24,lo8(g_eeprom)
	ldi r25,hi8(g_eeprom)
...
.LBB344:
	...
	andi r24,0xf0
	eor r25,r24
	subi r24,lo8(-(g_eeprom+1))
	sbci r25,hi8(-(g_eeprom+1))
	call eeprom_update_byte
.LVL220:
	.loc 1 619 0
	movw r30,r14
...
.LFE54:
	...
	.section	.bss.selftest.4631,"aw",@nobits
	.type	selftest.4631, @object
	.size	selftest.4631, 1
selftest.4631:
	.zero	1
	.section	.progmem.data.__c.4573,"a",@progbits
	.type	__c.4573, @object
	.size	__c.4573, 10
__c.4573:
	.string	"gbmelder2"
.global	hardwaretyp
	.section	.bss.hardwaretyp,"aw",@nobits
	.type	hardwaretyp, @object
	.size	hardwaretyp, 1
hardwaretyp:
	.zero	1
.global	g_eeprom
...
g_eeprom:
	.zero	257
.global	g_dec_lastaddr
	.section	.bss.g_dec_lastaddr,"aw",@nobits
	.type	g_dec_lastaddr, @object
	.size	g_dec_lastaddr, 2
g_dec_lastaddr:
	.zero	2
	.comm	g_dccdec,18,1
	.comm	g_power_on,1,1
	.comm	g_power_on_timer,3,1
	.comm	g_led_timer,3,1
	.comm	g_locoaddr_pipe,68,1
.global	g_transmit_seq
	.section	.bss.g_transmit_seq,"aw",@nobits
	.type	g_transmit_seq, @object
	.size	g_transmit_seq, 1
g_transmit_seq:
	.zero	1
.global	g_led_counter
	.section	.bss.g_led_counter,"aw",@nobits
	.type	g_led_counter, @object
	.size	g_led_counter, 1
g_led_counter:
	.zero	1
	.comm	g_sensors,112,1
.global	g_sensor_bits_1
	.section	.bss.g_sensor_bits_1,"aw",@nobits
	.type	g_sensor_bits_1, @object
	.size	g_sensor_bits_1, 2
g_sensor_bits_1:
	.zero	2
.global	g_sensor_bits
	.section	.bss.g_sensor_bits,"aw",@nobits
	.type	g_sensor_bits, @object
	.size	g_sensor_bits, 2
g_sensor_bits:
	.zero	2
	.comm	g_old_holdtime,1,1
	.comm	g_holdtime,1,1
	.text
.Letext0:
	.file 6 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdint.h"
	.file 7 "C:\\Program Files (x86)\\Atmel\\Studio\\7.0\\Packs\\Atmel\\XMEGAA_DFP\\1.1.136\\include/avr/iox32a4u.h"
...
.Ldebug_macro0:
	...
	.byte	0x7
	.long	.Ldebug_macro1
	.file 10 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stddef.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0xa
	.byte	0x7
	...
	.long	.LASF562
	.byte	0x4
	.file 12 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\pgmspace.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0xc
	.byte	0x7
	.long	.Ldebug_macro4
	.file 13 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\inttypes.h"
	.byte	0x3
	.uleb128 0x58
	.uleb128 0xd
	.byte	0x7
	...
	.long	.Ldebug_macro6
	.byte	0x4
	.file 14 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\io.h"
	.byte	0x3
	.uleb128 0x5a
	.uleb128 0xe
	.byte	0x5
	.uleb128 0x61
	.long	.LASF676
	.file 15 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\sfr_defs.h"
	.byte	0x3
	.uleb128 0x63
	.uleb128 0xf
	.byte	0x7
	...
	.long	.Ldebug_macro8
	.byte	0x4
	.file 16 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\portpins.h"
	.byte	0x3
	.uleb128 0x273
	.uleb128 0x10
	.byte	0x7
	.long	.Ldebug_macro9
	.byte	0x4
	.file 17 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\common.h"
	.byte	0x3
	.uleb128 0x275
	.uleb128 0x11
	.byte	0x7
	.long	.Ldebug_macro10
	.byte	0x4
	.file 18 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\version.h"
	.byte	0x3
	.uleb128 0x277
	.uleb128 0x12
	.byte	0x7
	.long	.Ldebug_macro11
	.byte	0x4
	.file 19 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\xmega.h"
	.byte	0x3
	.uleb128 0x27a
	.uleb128 0x13
	.byte	0x7
	.long	.Ldebug_macro12
	.byte	0x4
	.file 20 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\fuse.h"
	.byte	0x3
	.uleb128 0x27e
	.uleb128 0x14
	.byte	0x7
	.long	.Ldebug_macro13
	.byte	0x4
	.file 21 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\lock.h"
	.byte	0x3
	.uleb128 0x281
	.uleb128 0x15
	.byte	0x7
	...
	.long	.Ldebug_macro15
	.byte	0x4
	.file 22 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\interrupt.h"
	.byte	0x3
	.uleb128 0x11
	.uleb128 0x16
	.byte	0x7
	.long	.Ldebug_macro16
	.byte	0x4
	.file 23 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\wdt.h"
	.byte	0x3
	.uleb128 0x12
	.uleb128 0x17
	.byte	0x7
	...
	.long	.Ldebug_macro18
	.byte	0x4
	.file 24 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\util\\delay.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x18
	.byte	0x7
	.long	.Ldebug_macro19
	.file 25 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\util\\delay_basic.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x19
	.byte	0x5
	...
	.long	.LASF4173
	.byte	0x4
	.file 26 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\math.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x1a
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 27 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\sleep.h"
	.byte	0x3
	.uleb128 0x15
	.uleb128 0x1b
	.byte	0x7
	...
	.long	.Ldebug_macro22
	.byte	0x4
	.file 28 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\string.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x1c
	.byte	0x7
	...
	.uleb128 0x1a
	.long	.LASF4246
	.file 29 "C:\\Users\\balagi\\Documents\\git/avrutilslib/defines.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0x1d
	.byte	0x5
	.uleb128 0x15
	.long	.LASF4247
	.file 30 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\cpufunc.h"
	.byte	0x3
	.uleb128 0x19
	.uleb128 0x1e
	.byte	0x7
...
.Ldebug_macro29:
	...
	.long	.LASF4415
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.dccdec.hh.26.d2ee333f33996bcbf0a05dd08f6d757b,comdat
.Ldebug_macro30:
	.word	0x4
	.byte	0
	.byte	0x5
...
.LASF4422:
	.string	"NUM_SENSORS (hardwaretyp == HWTYPE_NEW ? 10 : 16)"
.LASF1067:
